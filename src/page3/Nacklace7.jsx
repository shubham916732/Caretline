...
export default function Nacklace7() {
  return (
                    ...
                    <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="https://www.caretline.com/product/necklace/Trillium%20Cluster%20Chain%20Necklace%201.jpg" className="d-block w-100" alt="First slide"/>
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/necklace/Trillium%20Cluster%20Chain%20Necklace%202.jpg" className="second-slide w-100" alt="Second slide"/>
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/necklace/Trillium%20Cluster%20Chain%20Necklace%203.jpg" className="w-100" alt="Third slide"/>
                            </div>
                        </div>
