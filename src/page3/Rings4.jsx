...
export default function Rings4() {
                    ...
                    <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="https://www.caretline.com/product/rings/Love%20Knot%20Solitaire%20Ring%201.png" className="d-block w-100" alt="First slide"/>
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/rings/Love%20Knot%20Solitaire%20Ring%203.png" className="second-slide w-100" alt="Second slide"/>
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/rings/Love%20Knot%20Solitaire%20Ring%202.png" className="w-100" alt="Third slide"/>
                            </div>
                        </div>
