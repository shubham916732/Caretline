        ...
        <div className="container-fluid mt-5">
            <div className="row align-items-center">
                <div className="col-md-6 justify-content-center">
                    <div id="carouselExampleAutoplaying" className="crsl carousel slide" data-bs-ride="carousel"
                        data-bs-interval="2000">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src="https://www.caretline.com/product/rings/Pinnacle%20Solitaire%20Ring%201.png"
                                    className="d-block w-100" alt="First slide" />
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/rings/Pinnacle%20Solitaire%20Ring%202.png"
                                    className="second-slide w-100" alt="Second slide" />
                            </div>
                            <div className="carousel-item">
                                <img src="https://www.caretline.com/product/rings/Pinnacle%20Solitaire%20Ring%202.png"
                                    className="w-100" alt="Third slide" />
                            </div>
                        </div>
