...
export default function Earring9() {
  return (
            ...
            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://www.caretline.com/product/earring/Mishka%20Bloom%20Drop%20Earrings%201.jpg" className="d-block w-100" alt="First slide"/>
                    </div>
                    <div className="carousel-item">
                        <img src="https://www.caretline.com/product/earring/Mishka%20Bloom%20Drop%20Earrings%202.jpg" className="second-slide w-100" alt="Second slide"/>
                    </div>
                    <div className="carousel-item">
                        <img src="https://www.caretline.com/product/earring/Mishka%20Bloom%20Drop%20Earrings%203.jpg" className="w-100" alt="Third slide"/>
                    </div>
                </div>
